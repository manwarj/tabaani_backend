...
module.exports = async (userEmail, firstName, restoreToken, origin) => {
  try {
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff; border-radius:16px; overflow:hidden; box-shadow: 0 4px 24px rgba(59,130,246,0.10);">
          ...
          <tr>
            <td style="padding: 48px 40px 32px 40px;">
              ...
              <h2 style="margin:0 0 8px 0; color:#1d4ed8; font-size:24px;">
                Restore Your Account 🔓
              </h2>

              <p style="margin:0 0 24px 0; color:#374151; font-size:16px; line-height:1.6;">
                Hello <strong>${firstName}</strong>, we received a request to restore your TABAANI account.
              </p>
                ...
                <tr>
                  <td style="background:#eff6ff; border-left:4px solid #3b82f6; border-radius:8px; padding:20px 24px;">
                    <p style="margin:0; color:#374151; font-size:14px; line-height:1.6;">
                      Click the button below to restore your account and regain access.
                      For your security, this link will
                      <strong style="color:#1d4ed8;">expire in 15 minutes</strong>.
                    </p>
                  </td>
                </tr>
              </table>
              ...
              <table cellpadding="0" cellspacing="0" width="100%" style="margin-bottom:32px;">
                <tr>
                  <td align="center">
                    <a href="${origin}/restore-account/${restoreToken}" target="_blank"
              ...
              <p style="margin:0 0 32px 0; color:#9ca3af; font-size:13px; text-align:center; line-height:1.6;">
                ...
                <a href="${origin}/restore-account/${restoreToken}" style="color:#3b82f6; word-break:break-all;">
                  ${origin}/restore-account/${restoreToken}
                </a>
              </p>
                ...
                <tr>
                  <td style="background:#fef2f2; border-left:4px solid #ef4444; border-radius:8px; padding:16px 24px;">
                    <p style="margin:0; color:#7f1d1d; font-size:14px; line-height:1.6;">
                      ...
                      If you did not request to restore your account, simply ignore this email. Your account will remain unchanged.
                    </p>
                  </td>
                </tr>
              </table>
          ...
          <tr>
            <td style="padding:24px 40px 40px 40px; text-align:center;">
              ...
              <p style="margin:8px 0 0 0;">
                <a href="${origin}" style="color:#3b82f6; font-size:12px; text-decoration:none;">
                  www.tabaani.nl
                </a>
              </p>
