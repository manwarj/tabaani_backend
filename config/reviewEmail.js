          ...
          <tr>
            <td style="padding: 48px 40px 32px 40px;">
                ...
                <tr>
                  <td style="background:#eff6ff; border-left:4px solid #3b82f6; border-radius:8px; padding:20px 24px;">
                    <p style="margin:0; color:#374151; font-size:14px; line-height:1.6;">
                      Your feedback helps other tourists find the best guides on TABAANI. 
                      It only takes a minute and means a lot to our guide community! 🙏
                    </p>
                  </td>
                </tr>
              </table>
              ...
              <table cellpadding="0" cellspacing="0" width="100%" style="margin-bottom:32px;">
                <tr>
                  <td align="center">
                    <a href="${origin}/review/${bookingId}" target="_blank"
              ...
              <p style="margin:0; color:#9ca3af; font-size:13px; text-align:center; line-height:1.6;">
                ...
                <a href="${origin}/review/${bookingId}" style="color:#3b82f6; word-break:break-all;">
                  ${origin}/review/${bookingId}
                </a>
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 24px 40px 40px 40px; text-align:center;">
              <p style="margin:0 0 8px 0; color:#6b7280; font-size:13px;">
                Thank you for being part of the TABAANI community!
              </p>
